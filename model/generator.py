...
class SequenceGeneratorModel(nn.Module):
    ...
    def __init__(self, seq2seq_model: Seq2SeqModel, bos_token_id, eos_token_id=None, max_length=30, max_len_a=0.0,
                 ...
                 restricter=None,decode_mask=True,relation_ids=None,component_ids=None,none_ids=None):
        """
        ...
        """
        assert relation_ids is not None and component_ids is not None and none_ids is not None
        super().__init__()
        self.seq2seq_model = seq2seq_model
        self.restricter = restricter
        seq2seq_model.decoder.relation_ids = relation_ids
        seq2seq_model.decoder.component_ids = component_ids
        seq2seq_model.decoder.none_ids = none_ids
    ...
    def forward(self, src_tokens, tgt_tokens, CPM_tag=None, src_seq_len=None,  first=None):
        """
        ...
        :return:src_tokens, tgt_tokens, src_seq_len,  first,CPM_tag
        """
        return self.seq2seq_model(src_tokens, tgt_tokens, src_seq_len, first,CPM_tag=CPM_tag,)
...
class SequenceGenerator:
    ...
    def __init__(self, decoder: Seq2SeqDecoder, max_length=20, max_len_a=0.0, num_beams=1,
                 ...
                 repetition_penalty=1, length_penalty=1.0, pad_token_id=0, restricter=None,decode_mask=True):
        """
    ...
    def set_new_generator(self, max_length=-1, max_len_a=-1, num_beams=-1,
        ...
        self.generate_func = partial(greedy_generate, decoder=self.decoder, max_length=max_length, max_len_a=max_len_a,
                                     ...
                                     restricter=restricter,decode_mask=self.decode_mask)
    ...
    def generate(self, state, src_seq_len=None,tokens=None,ner_tag=None):
        ...
        return self.generate_func(tokens=tokens, state=state,ner_tag=ner_tag,src_seq_len=src_seq_len)
...
def greedy_generate(decoder, tokens=None, state=None, max_length=20, max_len_a=0.0, num_beams=1,
                    ...
                    repetition_penalty=1, length_penalty=1.0, restricter=None,ner_tag = None,src_seq_len=None,decode_mask=True):
    """
    贪婪地搜索句子
    ...
    token_ids = _beam_search_generate(decoder, tokens=tokens, state=state, max_length=max_length, max_len_a=max_len_a,
                                        ...
                                        repetition_penalty=repetition_penalty, length_penalty=length_penalty,
                                        pad_token_id=pad_token_id, restricter=restricter,src_seq_len=src_seq_len,decode_mask=decode_mask)
...
def _beam_search_generate(decoder: Seq2SeqDecoder, tokens=None, state=None, max_length=20, max_len_a=0.0, num_beams=4,
                          ...
                          restricter=None,src_seq_len=None,decode_mask=True) -> torch.LongTensor:
    assert do_sample is False
    # 进行beam search
    relation_ids=decoder.relation_ids 
    component_ids=decoder.component_ids 
