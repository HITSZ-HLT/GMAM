...
class Attention(nn.Module):
    ...
    def _mf_shape(self, tensor, encode_len, bsz, decode_len=None):#-->>> <head*bsz, decode_len, -1, encode_len>
        tensor = tensor.transpose(1,2)
        decode_len = tensor.size(0)
        return tensor.contiguous().view(decode_len,encode_len, bsz * self.num_heads, self.head_dim).transpose(1,2)
    ...
    def forward(
        ...
        q = self._shape(q, tgt_len, bsz) # <bsz,decode_dim,dim> ---->>>> <bsz * self.num_heads, decode_dim, self.head_dim> 
